...
<?php	} ?>
			<form role="form" action="" method="post" id="form" enctype="multipart/form-data">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									...
									<textarea col="5" rows="4"  class="form-control" required placeholder="Address"  name="address" id="" /><?php if(!empty($data['address'])){ echo $data['address']; }?></textarea>
								</div>
							</div><br>
							<div class="row">
								...
								<div class="col-sm-3">
									...
									<input  type="text" class="form-control" required  name="fax" placeholder="Fax" value="<?php if(!empty($data['fax'])){ echo $data['fax']; }?>" />
								</div>
								<div class="col-sm-4">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-library"></i> Office Timing</h6>
					</div>
					<div class="panel-body">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-3">
									<label>Monday <span style="color:red">*</span> </label>
									<input class="form-control" required placeholder="Monday"  name="monday" value="<?php if(!empty($data['monday'])){ echo $data['monday']; }?>" />
								</div>
								<div class="col-sm-3">
									<label>Tuesday <span style="color:red">*</span> </label>
									<input  type="text" class="form-control" required placeholder="Tuesday" name="tuesday" value="<?php if(!empty($data['tuesday'])){ echo $data['tuesday']; }?>" />
								</div>
								<div class="col-sm-3">
									<label>Wednesday <span style="color:red">*</span> </label>
									<input  type="text" class="form-control" required  name="wednesday" placeholder="Wednesday" value="<?php if(!empty($data['wednesday'])){ echo $data['wednesday']; }?>" />
								</div>
								<div class="col-sm-3">
									<label>Thursday  <span style="color:red">*</span> </label>
									<input  type="text" class="form-control" required  name="thursday" placeholder="Thursday" value="<?php if(!empty($data['thursday'])){ echo $data['thursday']; }?>" />
								</div>
							</div><br>
							<div class="row">
								<div class="col-sm-3">
									<label>Friday <span style="color:red">*</span> </label>
									<input class="form-control" required placeholder="Friday"  name="friday" value="<?php if(!empty($data['friday'])){ echo $data['friday']; }?>" />
								</div>
								<div class="col-sm-3">
									<label>Saturday <span style="color:red">*</span> </label>
									<input  type="text" class="form-control" required placeholder="Saturday" name="saturday" value="<?php if(!empty($data['saturday'])){ echo $data['saturday']; }?>" />
								</div>
								<div class="col-sm-3">
									<label>Sunday <span style="color:red">*</span> </label>
									<input  type="text" class="form-control" required  name="sunday" placeholder="Sunday" value="<?php if(!empty($data['sunday'])){ echo $data['sunday']; }?>" />
								</div>
							</div><br>
